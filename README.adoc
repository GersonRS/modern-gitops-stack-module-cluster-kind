...
TIP: An example of a deployment of the Modern Gitops Stack using KinD is available https://github.com/camptocamp/modern-gitops-stack/tree/main/examples/kind[here] as well as an accompanying xref:ROOT:tutorials/deploy_kind.adoc[quick tutorial].
...
----
module "kind" {
  source = "git::https://github.com/camptocamp/modern-gitops-stack-module-kind.git?ref=<RELEASE>"
